...
module.exports = function pbkdf2(password, salt, iterations, keylen, digest, cb) {
  ...
  assert(
    Buffer.isBuffer(password) || password instanceof ArrayBuffer || ArrayBuffer.isView(password)
  )
  assert(Buffer.isBuffer(salt) || salt instanceof ArrayBuffer || ArrayBuffer.isView(salt))
