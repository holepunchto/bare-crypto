...
exports.sign = function sign(algorithm, data, key) {
  assert(data instanceof Buffer || data instanceof ArrayBuffer || ArrayBuffer.isView(data))
...
exports.verify = function verify(algorithm, data, key, signature) {
  ...
  assert(
    signature instanceof Buffer || signature instanceof ArrayBuffer || ArrayBuffer.isView(signature)
  )
