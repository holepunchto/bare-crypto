...
/**
 * The supported algorithm constants: `hash` (hash algorithms), `cipher` (symmetric cipher
 * algorithms), `signature` (signature algorithms), and `keyType` (asymmetric key types).
 */
