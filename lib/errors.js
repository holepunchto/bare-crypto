module.exports = class CryptoError extends Error {
  ...
  static UNKNOWN_ALGORITHM(msg) {
    return new CryptoError(msg, CryptoError.UNKNOWN_ALGORITHM)
  }

  static UNKNOWN_FORMAT(msg) {
    return new CryptoError(msg, CryptoError.UNKNOWN_FORMAT)
  }
